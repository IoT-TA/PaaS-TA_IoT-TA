...
exports.rule = {
    create(context) {
        ...
        return {
            ...
            'Program:exit': () => {
                reachingDefinitions_1.reachingDefinitions(reachingDefsMap);
        ...
        function checkSegment(reachingDefs) {
            ...
            reachingDefs.references.forEach(ref => {
                ...
                const rhsValues = reachingDefinitions_1.resolveAssignedValues(variable, ref.writeExpr, assignedValuesMap, ref.from);
...
function isSelfAssignement(ref) {
    ...
    if (((_a = ref.writeExpr) === null || _a === void 0 ? void 0 : _a.type) === 'Identifier') {
        const rhs = reachingDefinitions_1.getVariableFromIdentifier(ref.writeExpr, ref.from);
        return lhs === rhs;
    }
    return false;
}
