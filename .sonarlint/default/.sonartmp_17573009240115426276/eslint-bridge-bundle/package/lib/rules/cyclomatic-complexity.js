...
exports.rule = {
    ...
    create(context) {
        ...
        return {
            ...
            'FunctionDeclaration, FunctionExpression, ArrowFunctionExpression': (node) => functionsWithParent.set(node, utils_1.getParent(context)),
        ...
        const visitNode = (node) => {
            ...
            if (utils_1.isFunctionNode(node)) {
                if (node !== this.root) {
                    ...
                    token = {
                        loc: locations_1.getMainFunctionTokenLocation(node, this.parent, this.context),
                    };
                }
            }
            else {
