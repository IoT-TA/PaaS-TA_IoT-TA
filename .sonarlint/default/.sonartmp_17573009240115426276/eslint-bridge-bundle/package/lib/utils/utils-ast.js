...
function isIdentifier(node, ...values) {
    return (node.type === 'Identifier' && (values.length === 0 || values.some(value => value === node.name)));
}
